  ...
  return (
    <section className="about-page">
      ...
      <div className="about-section">
        <div className="about-image-first-div">
          <div className="about-image">
            <img src={crayons} alt="Our Vision" />
          </div>
        </div>
      ...
      <div className="about-section-reverse">
        <div className="about-text">
          ...
          <p style={{ color: "#FFD000" }}>
            ...
            productivity, and improve everyday experiences. Our goal is to
            empower individuals and organizations to work smarter, not harder,
            by delivering intuitive, reliable products that make life easier{" "}
          </p>
        </div>
      ...
      <div className="about-section">
        <div className="about-image-first-div">
          <div className="about-image">
            <img src={childonglasses} alt="About Iyare Learning Hub" />
          </div>
        </div>
        <div className="about-text">
